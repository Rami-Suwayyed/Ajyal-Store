            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-category">
                        ...
                        <ul>
                            <li><a href="{{route('products.index')}}">Smart Television</a></li>
                            <li><a href="{{route('products.index')}}">QLED TV</a></li>
                            <li><a href="{{route('products.index')}}">Audios</a></li>
            ...
            <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-12">
                            ...
                            <div class="single-product">
                                ...
                                <div class="product-info">
                                    ...
                                    <h4 class="title">
                                        <a href="{{route('products.index')}}">WiFi Security Camera</a>
                                    </h4>
                                    <ul class="review">
                        ...
                        <div class="col-lg-4 col-md-4 col-12">
                            ...
                            <div class="single-product">
                                ...
                                <div class="product-info">
                                    ...
                                    <h4 class="title">
                                        <a href="{{route('products.index')}}">Apple MacBook Air</a>
                                    </h4>
                                    <ul class="review">
                                        <li><i class="lni lni-star-filled"></i></li>
                                        <li><i class="lni lni-star-filled"></i></li>
                        ...
                        <div class="col-lg-4 col-md-4 col-12">
                            ...
                            <div class="single-product">
                                ...
                                <div class="product-info">
                                    ...
                                    <h4 class="title">
                                        <a href="{{route('products.index')}}">Bluetooth Speaker</a>
                                    </h4>
                                    <ul class="review">
                                        <li><i class="lni lni-star-filled"></i></li>
                                        <li><i class="lni lni-star-filled"></i></li>
                ...
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="offer-content">
                        ...
                        <div class="text">
                            <h2><a href="{{route('products.index')}}">Bluetooth Headphone</a></h2>
                            <ul class="review">
                                <li><i class="lni lni-star-filled"></i></li>
                                <li><i class="lni lni-star-filled"></i></li>
                                <li><i class="lni lni-star-filled"></i></li>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-12 custom-responsive-margin">
                    ...
                    <div class="single-list">
                        <div class="list-image">
                            <a href="{{route('products.index')}}"><img src="https://via.placeholder.com/100x100" alt="#"></a>
                        </div>
                        <div class="list-info">
                            <h3>
                                <a href="{{route('products.index')}}">GoPro Hero4 Silver</a>
                            </h3>
                            <span>$287.99</span>
                        </div>
                    </div>
                    ...
                    <div class="single-list">
                        ...
                        <div class="list-info">
                            <h3>
                                <a href="{{route('products.index')}}">Puro Sound Labs BT2200</a>
                            </h3>
                            <span>$95.00</span>
                        </div>
                    </div>
                    ...
                    <div class="single-list">
                        ...
                        <div class="list-info">
                            <h3>
                                <a href="{{route('products.index')}}">HP OfficeJet Pro 8710</a>
                            </h3>
                            <span>$120.00</span>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-4 col-12 custom-responsive-margin">
                    ...
                    <div class="single-list">
                        ...
                        <div class="list-info">
                            <h3>
                                <a href="{{route('products.index')}}">iPhone X 256 GB Space Gray</a>
                            </h3>
                            <span>$1150.00</span>
                        </div>
                    </div>
                    ...
                    <div class="single-list">
                        ...
                        <div class="list-info">
                            <h3>
                                <a href="{{route('products.index')}}">Canon EOS M50 Mirrorless Camera</a>
                            </h3>
                            <span>$950.00</span>
                        </div>
                    </div>
                    ...
                    <div class="single-list">
                        ...
                        <div class="list-info">
                            <h3>
                                <a href="{{route('products.index')}}">Microsoft Xbox One S</a>
                            </h3>
                            <span>$298.00</span>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    ...
                    <div class="single-list">
                        ...
                        <div class="list-info">
                            <h3>
                                <a href="{{route('products.index')}}">Samsung Gear 360 VR Camera</a>
                            </h3>
                            <span>$68.00</span>
                        </div>
                    </div>
                    ...
                    <div class="single-list">
                        ...
                        <div class="list-info">
                            <h3>
                                <a href="{{route('products.index')}}">Samsung Galaxy S9+ 64 GB</a>
                            </h3>
                            <span>$840.00</span>
                        </div>
                    </div>
                    ...
                    <div class="single-list">
                        ...
                        <div class="list-info">
                            <h3>
                                <a href="{{route('products.index')}}">Zeus Bluetooth Headphones</a>
                            </h3>
                            <span>$28.00</span>
                        </div>
                    </div>
