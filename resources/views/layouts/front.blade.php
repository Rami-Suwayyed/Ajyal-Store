                    ...
                    <div class="nav-inner">
                        ...
                        <div class="mega-category-menu">
                            ...
                            <ul class="sub-category">
                                <li><a href="{{route('products.index')}}">Electronics <i class="lni lni-chevron-right"></i></a>
                                    <ul class="inner-sub-category">
                                        <li><a href="{{route('products.index')}}">Digital Cameras</a></li>
                                        <li><a href="{{route('products.index')}}">Camcorders</a></li>
                                        <li><a href="{{route('products.index')}}">Camera Drones</a></li>
                                        <li><a href="{{route('products.index')}}">Smart Watches</a></li>
                                        <li><a href="{{route('products.index')}}">Headphones</a></li>
                                        <li><a href="{{route('products.index')}}">MP3 Players</a></li>
                                        <li><a href="{{route('products.index')}}">Microphones</a></li>
                                        <li><a href="{{route('products.index')}}">Chargers</a></li>
                                        <li><a href="{{route('products.index')}}">Batteries</a></li>
                                        <li><a href="{{route('products.index')}}">Cables & Adapters</a></li>
                                    </ul>
                                </li>
                                <li><a href="{{route('products.index')}}">accessories</a></li>
                                <li><a href="{{route('products.index')}}">Televisions</a></li>
                                <li><a href="{{route('products.index')}}">best selling</a></li>
                                <li><a href="{{route('products.index')}}">top 100 offer</a></li>
                                <li><a href="{{route('products.index')}}">sunglass</a></li>
                                <li><a href="{{route('products.index')}}">watch</a></li>
                                <li><a href="{{route('products.index')}}">man’s product</a></li>
                                <li><a href="{{route('products.index')}}">Home Audio & Theater</a></li>
                                <li><a href="{{route('products.index')}}">Computers & Tablets </a></li>
                                <li><a href="{{route('products.index')}}">Video Games </a></li>
                                <li><a href="{{route('products.index')}}">Home Appliances </a></li>
                            </ul>
                        </div>
                                ...
                                <ul id="nav" class="navbar-nav ms-auto">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <ul class="sub-menu collapse" id="submenu-1-3">
                                            <li class="nav-item"><a href="{{route('products.index')}}">Shop Grid</a></li>
